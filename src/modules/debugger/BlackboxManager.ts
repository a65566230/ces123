...
export class BlackboxManager {
    cdpSession;
    blackboxedPatterns = new Set();
    static COMMON_LIBRARY_PATTERNS = [
        '*jquery*.js',
        '*react*.js',
        '*react-dom*.js',
        '*vue*.js',
    ...
    async unblackboxByPattern(urlPattern) {
    ...
    getAllBlackboxedPatterns() {
        return Array.from(this.blackboxedPatterns);
    }
    async clearAllBlackboxedPatterns() {
...
//# sourceMappingURL=BlackboxManager.js.map
